...
SKILL_DIR="/root/.opencode/skills/$FIXTURE"
FIXTURE_PATH="/fixtures/$FIXTURE"

check_fixture "$FIXTURE"

log "Testing cap install for $FIXTURE on OpenCode..."
if ! cap install "$FIXTURE_PATH" --framework opencode --skip-runtime-check --yes; then
